...
export const QUADRANTS: QuadrantDef[] = [
  {
    key: 'now',
    label: '今すぐやる',
    icon: '<svg width="16" height="16" viewBox="0 0 64 64" fill="none" stroke="currentColor" stroke-width="3.6" stroke-linecap="round" stroke-linejoin="round"><path d="M32 8 Q46 20 44 40 L32 52 L20 40 Q18 20 32 8 Z"/><circle cx="32" cy="26" r="5"/><path d="M20 40 L12 52 L22 48"/><path d="M44 40 L52 52 L42 48"/></svg>',
  ...
  },
  {
    key: 'build',
    label: '仕組み化して取り組む',
    icon: '<svg width="16" height="16" viewBox="0 0 64 64" fill="none" stroke="currentColor" stroke-width="3.6" stroke-linecap="round" stroke-linejoin="round"><circle cx="32" cy="32" r="10"/><path d="M32 8 V16 M32 48 V56 M8 32 H16 M48 32 H56 M14.5 14.5 L20 20 M44 44 L49.5 49.5 M14.5 49.5 L20 44 M44 20 L49.5 14.5"/></svg>',
  ...
  },
  {
    key: 'gap',
    label: 'スキマ時間で',
    icon: '<svg width="16" height="16" viewBox="0 0 64 64" fill="none" stroke="currentColor" stroke-width="3.6" stroke-linecap="round" stroke-linejoin="round"><path d="M16 24 H40 V44 Q40 52 32 52 H24 Q16 52 16 44 Z"/><path d="M40 28 H46 Q52 28 52 34 Q52 40 46 40 H40"/><path d="M22 16 Q24 20 22 24 M32 16 Q34 20 32 24"/></svg>',
  ...
  },
  {
    key: 'trim',
    label: 'やめる・減らす・任せる',
    icon: '<svg width="16" height="16" viewBox="0 0 64 64" fill="none" stroke="currentColor" stroke-width="3.6" stroke-linecap="round" stroke-linejoin="round"><circle cx="18" cy="18" r="6"/><circle cx="18" cy="46" r="6"/><line x1="23" y1="22" x2="52" y2="46"/><line x1="23" y1="42" x2="52" y2="18"/></svg>',
